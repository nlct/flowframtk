              ...
              ChangeListener
{
   ...
   private void initMarkers()
   {
      ...
      arrowStyles = new MarkerItem[]
      {
         ...
         new MarkerItem(getResources(), JDRMarker.ARROW_STEALTH2,
            getResources().getMessage("arrow.stealth2")),
      ...
      dataStyles = new MarkerItem[]
      {
         ...
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_TRIANGLEUP2_FILLED,
            getResources().getMessage("arrow.indep_centred_triangleup2_filled")),
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_TRIANGLEUP2_OPEN,
            getResources().getMessage("arrow.indep_centred_triangleup2_open")),
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_TRIANGLEDOWN2_FILLED,
            getResources().getMessage("arrow.indep_centred_triangledown2_filled")),
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_TRIANGLEDOWN2_OPEN,
            getResources().getMessage("arrow.indep_centred_triangledown2_open")),
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_RECTANGLE2_FILLED,
            getResources().getMessage("arrow.indep_centred_rectangle2_filled")),
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_RECTANGLE2_OPEN,
            getResources().getMessage("arrow.indep_centred_rectangle2_open")),
         new MarkerItem(getResources(),
            JDRMarker.ARROW_INDEP_CENTRED_ELLIPSE2_FILLED,
            getResources().getMessage("arrow.indep_centred_ellipse2_filled")),
         new MarkerItem(getResources(),
