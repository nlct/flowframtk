 ...
 *
 */
public class ArrowIndepCentredTriangleDown2Open extends JDRMarker
{
   /**
    * Creates triangle down marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowIndepCentredTriangleDown2Open(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowLength, JDRLength arrowWidth)
   {
      ...
      type = ARROW_INDEP_CENTRED_TRIANGLEDOWN2_OPEN;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"indepcentredtriangledown2open-"+size+"-"+width:
           "arrow-"+repeated+"indepcentredtriangledown2open-"+size+"-"+width;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowIndepCentredTriangleDown2Open(penWidth, repeated,
