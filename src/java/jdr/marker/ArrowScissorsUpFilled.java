// File          : ArrowScissorsUpFilled.java
...
/**
 * Filled upward facing broken scissor marker.
 * The basic marker shape looks like:
 * <img src="../images/scissorUpFilledMarker.png" alt="[filled upward partial scissors]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowScissorsUpFilled extends JDRMarker
{
   /**
    * Creates filled upward partial scissor marker of given size.
    * The marker may be repeated and/or reversed.
    */
   public ArrowScissorsUpFilled(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength markerSize)
   {
      super(penwidth, repeat, isReversed, markerSize);

      type = ARROW_SCISSORS_UP_FILLED;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"scissorsupfilled":
           "arrow-"+repeated+"scissorsupfilled";
   }
   ...
   public GeneralPath getGeneralPath()
   {
      ...
      float halfW = (float)(0.5*penWidth.getValue());
      double dx = -16.0;
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowScissorsUpFilled(penWidth, repeated,
