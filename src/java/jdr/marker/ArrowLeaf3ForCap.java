 ...
 *
 */
public class ArrowLeaf3ForCap extends JDRMarker
{
   /**
    * Creates leaf3for marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowLeaf3ForCap(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_LEAF3FOR_CAP;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"leaf3forcap-"+size+"-"+penWidth:
           "arrow-"+repeated+"leaf3forcap-"+size+"-"+penWidth;
   }
