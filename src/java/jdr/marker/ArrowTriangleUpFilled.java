// File          : ArrowTriangleUpFilled.java
...
/**
 * Filled upward facing triangle marker.
 * The basic filled upward facing triangle marker shape looks like:
 * <img src="../images/triangleUpFilledMarker.png" alt="[filled upward facing triangle]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowTriangleUpFilled extends JDRMarker
{
   /**
    * Creates filled upward facing triangle marker of given size.
    ...
    */
   public ArrowTriangleUpFilled(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength markerSize)
   {
      super(penwidth, repeat, isReversed, markerSize);

      type = ARROW_TRIANGLE_UP_FILLED;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"triangleupfilled":
           "arrow-"+repeated+"triangleupfilled";
   }
   ...
   protected String pgfarrow()
   {
      ...
      return "\\pgfsetdash{}{0pt}\\pgfsetlinewidth{2bp}"
           + "\\pgfpathqmoveto{0bp}{"+PGF.length(size)+"}"
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowTriangleUpFilled(penWidth, repeated,
