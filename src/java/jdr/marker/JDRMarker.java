...
public class JDRMarker implements Serializable,Cloneable,JDRConstants
{
      ...
      switch (markerID)
      {
         ...
         case ARROW_INDEP_CENTRED_TRIANGLE2_OPEN:
            marker = new ArrowIndepCentredTriangle2Open(penwidth, repeat,
              ...
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_RECTANGLE2_FILLED:
            marker = new ArrowIndepCentredRectangle2Filled(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_RECTANGLE2_OPEN:
            marker = new ArrowIndepCentredRectangle2Open(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_ELLIPSE2_FILLED:
            marker = new ArrowIndepCentredEllipse2Filled(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_ELLIPSE2_OPEN:
            marker = new ArrowIndepCentredEllipse2Open(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         ...
         case ARROW_INDEP_CENTRED_DIAMOND2_OPEN:
            marker = new ArrowIndepCentredDiamond2Open(penwidth, repeat,
              ...
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_TRIANGLEUP2_FILLED:
            marker = new ArrowIndepCentredTriangleUp2Filled(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_TRIANGLEUP2_OPEN:
            marker = new ArrowIndepCentredTriangleUp2Open(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_TRIANGLEDOWN2_FILLED:
            marker = new ArrowIndepCentredTriangleDown2Filled(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_INDEP_CENTRED_TRIANGLEDOWN2_OPEN:
            marker = new ArrowIndepCentredTriangleDown2Open(penwidth, repeat,
              isReversed, arrowSize, 
              arrowWidth == null ? (JDRLength)arrowSize.clone() : arrowWidth);
            break;
         case ARROW_CIRCLE :
   ...
   /**
    * Filled Independent Centred Rectangle2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_RECTANGLE2_FILLED=97;

   /**
    * Open Independent Centred Rectangle2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_RECTANGLE2_OPEN=98;

   /**
    * Filled Independent Centred Ellipse2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_ELLIPSE2_FILLED=99;

   /**
    * Open Independent Centred Ellipse2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   ...
   /**
    * Filled Independent Centred TriangleUp2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_TRIANGLEUP2_FILLED=103;

   /**
    * Open Independent Centred TriangleUp2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_TRIANGLEUP2_OPEN=104;

   /**
    * Filled Independent Centred TriangleDown2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_TRIANGLEDOWN2_FILLED=105;

   /**
    * Open Independent Centred TriangleDown2.
    * (JDR/AJR file formats version 2.2 onwards.)
    */
   public static final int ARROW_INDEP_CENTRED_TRIANGLEDOWN2_OPEN=106;

   /**
    * Maximum number of known markers for AJR and JDR file
    * versions 2.2 onwards
    */
   public static final int NUM_ARROWS2_2=107;
