...
/**
 * Leaf3 cap marker. The basic marker shape looks like:
 * <img src="../images/leaf3CapMarker.png" alt="[leaf3 shape]">
 ...
 *
 */
public class ArrowLeaf3Cap extends JDRMarker
{
   /**
    * Creates leaf3 marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowLeaf3Cap(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_LEAF3_CAP;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"leaf3cap-"+size+"-"+penWidth:
           "arrow-"+repeated+"leaf3cap-"+size+"-"+penWidth;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowLeaf3Cap(penWidth, repeated,
