 ...
 *
 */
public class ArrowIndepCentredTriangleUp2Open extends JDRMarker
{
   /**
    * Creates triangle up marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowIndepCentredTriangleUp2Open(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowLength, JDRLength arrowWidth)
   {
      ...
      type = ARROW_INDEP_CENTRED_TRIANGLEUP2_OPEN;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"indepcentredtriangleup2open-"+size+"-"+width:
           "arrow-"+repeated+"indepcentredtriangleup2open-"+size+"-"+width;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowIndepCentredTriangleUp2Open(penWidth, repeated,
