// File          : ArrowHalfPointedDown.java
...
/**
 * Half pointed down marker. The basic marker shape looks like:
 * <img src="../images/halfPointedDownMarker.png" alt="[ lower half pointed arrow shape]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowHalfPointedDown extends JDRMarker
{
   /**
    * Creates lower half of pointed marker of given size.
    * The marker may be repeated and/or reversed.
    */
   public ArrowHalfPointedDown(JDRLength penwidth, int repeat,
                       boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_HALF_POINTED_DOWN;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"halfpointeddown-"+size+"-"+penWidth:
           "arrow-"+repeated+"halfpointeddown-"+size+"-"+penWidth;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowHalfPointedDown(penWidth, repeated,
