 ...
 * <img src="../images/pointed45Marker.png" alt="[ &gt; shape]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowPointed45 extends JDRMarker
{
   /**
    * Creates pointed marker of given size.
    * The marker may be repeated and/or reversed.
    */
   public ArrowPointed45(JDRLength penwidth, int repeat,
                       boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_POINTED45;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"pointed45-"+size+"-"+penWidth:
           "arrow-"+repeated+"pointed45-"+size+"-"+penWidth;
   }
   ...
   public GeneralPath getGeneralPath()
   {
      ...
      // size * tan(pi/12)
      float y = (float)(markerSize*0.267949192);
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowPointed45(penWidth, repeated,
