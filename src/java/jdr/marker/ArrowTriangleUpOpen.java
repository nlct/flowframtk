...
/**
 * Open upward facing triangle marker.
 * The basic open upward facing triangle marker shape looks like:
 * <img src="../images/triangleUpOpenMarker.png" alt="[open upward facing triangle]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowTriangleUpOpen extends JDRMarker
{
   /**
    * Creates open upward facing triangle marker of given size.
    ...
    */
   public ArrowTriangleUpOpen(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength markerSize)
   {
      super(penwidth, repeat, isReversed, markerSize);

      type = ARROW_TRIANGLE_UP_OPEN;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"triangleupopen":
           "arrow-"+repeated+"triangleupopen";
   }
