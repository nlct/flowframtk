 ...
 *
 */
public class ArrowIndepCentredRectangle2Filled extends JDRMarker
{
   /**
    * Creates rectangle marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowIndepCentredRectangle2Filled(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowLength, JDRLength arrowWidth)
   {
      ...
      type = ARROW_INDEP_CENTRED_RECTANGLE2_FILLED;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"indepcentredrectangle2filled-"+size+"-"+width:
           "arrow-"+repeated+"indepcentredrectangle2filled-"+size+"-"+width;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowIndepCentredRectangle2Filled(penWidth, repeated,
