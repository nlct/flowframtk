...
/**
 * Alternative LaTeX style marker.
 * The basic marker shape looks like:
 * <img src="../images/altSingleMarker.png" alt="[alternative LaTeX arrow shape]">
 * This is a modification of the {@link ArrowSingle} marker that can be
 * resized.
 ...
 * @author Nicola L C Talbot
 */
public class ArrowAltSingle extends JDRMarker
{
   /**
    * Creates LaTeX style marker .
    * The marker may be repeated and/or reversed.
    */
   public ArrowAltSingle(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_ALT_SINGLE;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"altsingle-"+size+"-"+penWidth:
           "arrow-"+repeated+"altsingle-"+size+"-"+penWidth;
