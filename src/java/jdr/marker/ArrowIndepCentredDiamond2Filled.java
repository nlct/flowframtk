 ...
 *
 */
public class ArrowIndepCentredDiamond2Filled extends JDRMarker
{
   /**
    * Creates diamond marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowIndepCentredDiamond2Filled(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowLength, JDRLength arrowWidth)
   {
      ...
      type = ARROW_INDEP_CENTRED_DIAMOND2_FILLED;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"indepcentreddiamond2filled-"+size+"-"+width:
           "arrow-"+repeated+"indepcentreddiamond2filled-"+size+"-"+width;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowIndepCentredDiamond2Filled(penWidth, repeated,
