// File          : ArrowHeartRightFilled.java
...
/**
 * Right facing filled heart marker.
 * The basic marker shape looks like:
 * <img src="../images/heartrightFilledMarker.png" alt="[filled right facing heart]">
 * This marker's shape depends on the marker size.
 * See {@link JDRMarker} for a description of markers.
 *
 * @author Nicola L C Talbot
 */
public class ArrowHeartRightFilled extends JDRMarker
{
   /**
    * Creates right facing filled heart shaped marker of given size.
    * The marker may be repeated and/or reversed.
    */
   public ArrowHeartRightFilled(JDRLength penwidth, int repeat,
                       boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_HEART_RIGHT_FILLED;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"heartrightfilled-"+size:
           "arrow-"+repeated+"heartrightfilled-"+size;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowHeartRightFilled(penWidth, repeated,
