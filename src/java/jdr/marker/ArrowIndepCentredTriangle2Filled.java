 ...
 *
 */
public class ArrowIndepCentredTriangle2Filled extends JDRMarker
{
   /**
    * Creates triangle marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowIndepCentredTriangle2Filled(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowLength, JDRLength arrowWidth)
   {
      ...
      type = ARROW_INDEP_CENTRED_TRIANGLE2_FILLED;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"indepcentredtriangle2filled-"+size+"-"+width:
           "arrow-"+repeated+"indepcentredtriangle2filled-"+size+"-"+width;
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowIndepCentredTriangle2Filled(penWidth, repeated,
