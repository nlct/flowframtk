...
/**
 * Open upward facing broken scissor marker.
 * The basic marker shape looks like:
 * <img src="../images/scissorUpOpenMarker.png" alt="[open upward partial scissors]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowScissorsUpOpen extends JDRMarker
{
   /**
    * Creates open upward partial scissor marker of given size.
    * The marker may be repeated and/or reversed.
    */
   public ArrowScissorsUpOpen(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength markerSize)
   {
      super(penwidth, repeat, isReversed, markerSize);

      type = ARROW_SCISSORS_UP_OPEN;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"scissorsupopen":
           "arrow-"+repeated+"scissorsupopen";
   }
