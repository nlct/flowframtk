 ...
 *
 */
public class ArrowLeaf3BackCap extends JDRMarker
{
   /**
    * Creates leaf3for marker for a path with the given pen width.
    * The marker may be repeated and/or reversed.
    */
   public ArrowLeaf3BackCap(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength arrowSize)
   {
      super(penwidth, repeat, isReversed, arrowSize);

      type = ARROW_LEAF3BACK_CAP;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"leaf3backcap-"+size+"-"+penWidth:
           "arrow-"+repeated+"leaf3backcap-"+size+"-"+penWidth;
   }
