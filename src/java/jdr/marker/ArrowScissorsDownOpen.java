// File          : ArrowScissorsDownOpen.java
...
/**
 * Open downward facing broken scissor marker.
 * The basic marker shape looks like:
 * <img src="../images/scissorDownOpenMarker.png" alt="[open downward partial scissors]">
 ...
 * @author Nicola L C Talbot
 */
public class ArrowScissorsDownOpen extends JDRMarker
{
   /**
    * Creates open downward partial scissor marker of given size.
    * The marker may be repeated and/or reversed.
    */
   public ArrowScissorsDownOpen(JDRLength penwidth, int repeat,
                      boolean isReversed, JDRLength markerSize)
   {
      super(penwidth, repeat, isReversed, markerSize);

      type = ARROW_SCISSORS_DOWN_OPEN;
   }

   public String getID()
   {
      return reversed ?
           "arrow-r"+repeated+"scissorsdownopen":
           "arrow-"+repeated+"scissorsdownopen";
   }
   ...
   public Object clone()
   {
      JDRMarker marker = new ArrowScissorsDownOpen(penWidth, repeated,
