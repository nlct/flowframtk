// File          : JDRMissingTopLevelException.java
...
/**
 * Exception thrown if the top level object in a JDR/AJR file is not
 * a group.
 * @author Nicola L C Talbot
 */
public class JDRMissingTopLevelException extends InvalidFormatException
{
