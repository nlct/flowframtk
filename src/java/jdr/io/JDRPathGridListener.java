...
/**
 * Loader listener for path grids.
 * @author Nicola L C Talbot
 */

public class JDRPathGridListener implements JDRGridLoaderListener
{
   ...
   {
      return (version < 2.0f ? ((JDRPathGrid)grid).getRectangularGrid(): grid);
   }
      ...
      throws IOException
   {
      ...
      JDRPathGrid grid = (JDRPathGrid)object;
      ...
      throws InvalidFormatException
   {
      ...
      return new JDRPathGrid(jdr.getCanvasGraphics(),
         unit, majorDivisions, subDivisions, jdr.readShape());
   }
