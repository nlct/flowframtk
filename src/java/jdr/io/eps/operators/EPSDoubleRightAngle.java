 ...
 * @author Nicola L C Talbot
 */
public class EPSDoubleRightAngle extends EPSOperator
{
   public EPSDoubleRightAngle()
   {
      super(">>");
   }
             ...
             IOException
   {
      ...
      EPSDict dict = new EPSDict();

      while (!(value instanceof EPSDictMark))
      {
         EPSName key = stack.popEPSName();

         dict.put(key, value);

         value = stack.popObject();
      }
