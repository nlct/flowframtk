// File          : EPSRcurveTo.java
// Purpose       : class representing rcurveto operator
// Date          : 1st June 2008
...
/**
 * Object representing rcurveto operator.
 * @author Nicola L C Talbot
 */
public class EPSRcurveTo extends EPSOperator
{
   public EPSRcurveTo()
   {
      super("rcurveto");
             ...
             IOException
   {
      ...
      try
      {
         eps.getCurrentGraphicsState().rcurveTo((float)x1, (float)y1,
            (float)x2, (float)y2, (float)x3, (float)y3);
      }
      catch (NoCurrentPointException e)
      {
         throw new NoCurrentPointException(
            "(rcurveto) "+e.getMessage(), eps.getLineNum());
      }
   }
