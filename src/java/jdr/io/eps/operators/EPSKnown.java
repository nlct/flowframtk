// File          : EPSKnown.java
// Purpose       : class representing known operator
// Date          : 1st June 2008
...
/**
 * Object representing known operator.
 * @author Nicola L C Talbot
 */
public class EPSKnown extends EPSOperator
{
   public EPSKnown()
   {
      super("known");
             ...
             IOException
   {
      ...
      stack.pushBoolean(dict.get(key) != null);
   }
