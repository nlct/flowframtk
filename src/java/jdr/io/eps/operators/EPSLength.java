// File          : EPSLength.java
// Purpose       : class representing length operator
// Date          : 1st June 2008
...
/**
 * Object representing length operator.
 * @author Nicola L C Talbot
 */
public class EPSLength extends EPSOperator
{
   public EPSLength()
   {
      super("length");
             ...
             IOException
   {
      ...
      stack.pushInteger(object.length());
   }
