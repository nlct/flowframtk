// File          : EPSGet.java
// Purpose       : class representing get operator
// Date          : 1st June 2008
...
/**
 * Object representing get operator.
 * @author Nicola L C Talbot
 */
public class EPSGet extends EPSOperator
{
   public EPSGet()
   {
      super("get");
