// File          : EPSPrint.java
// Purpose       : class representing print operator
...
/**
 * Object representing print operator.
 * @author Nicola L C Talbot
 */
public class EPSPrint extends EPSOperator
{
   public EPSPrint()
   {
      super("print");
             ...
             IOException
   {
      ...
      eps.getMessageSystem().getPublisher().publishMessages(
         MessageInfo.createMessage(str, false));
   }
