// File          : EPSEoFill.java
// Purpose       : class representing eofill operator
// Date          : 1st June 2008
...
/**
 * Object representing eofill operator.
 * @author Nicola L C Talbot
 */
public class EPSEoFill extends EPSOperator
{
   public EPSEoFill()
   {
      super("eofill");
             ...
             IOException
   {
      ...
      JDRPath path = currentGraphicsState.createFilledPath(
