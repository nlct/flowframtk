// File          : EPSLineTo.java
// Purpose       : class representing lineto operator
// Date          : 1st June 2008
...
/**
 * Object representing lineto operator.
 * @author Nicola L C Talbot
 */
public class EPSLineTo extends EPSOperator
{
   public EPSLineTo()
   {
      super("lineto");
             ...
             IOException
   {
      ...
      try
      {
         eps.getCurrentGraphicsState().lineTo((float)x, (float)y);
      }
      catch (NoCurrentPointException e)
      {
         throw new NoCurrentPointException(
            "(lineto) "+e.getMessage(), eps.getLineNum());
      }
   }
