// File          : EPSScale.java
// Purpose       : class representing scale operator
// Date          : 1st June 2008
...
/**
 * Object representing scale operator.
 * @author Nicola L C Talbot
 */
public class EPSScale extends EPSOperator
{
   public EPSScale()
   {
      super("scale");
             ...
             IOException
   {
      ...
      else
      {
         ...
         eps.getCurrentGraphicsState().scale(x, y);
      }
   }
