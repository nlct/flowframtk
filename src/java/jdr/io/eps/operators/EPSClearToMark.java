// File          : EPSClearToMark.java
// Purpose       : class representing cleartomark operator
// Date          : 1st June 2008
...
/**
 * Object representing cleartomark operator.
 * @author Nicola L C Talbot
 */
public class EPSClearToMark extends EPSOperator
{
   public EPSClearToMark()
   {
      super("cleartomark");
   }
