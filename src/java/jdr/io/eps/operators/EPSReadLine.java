// File          : EPSReadLine.java
// Purpose       : class representing readline operator
// Date          : 1st June 2008
...
/**
 * Object representing readline operator.
 * @author Nicola L C Talbot
 */
public class EPSReadLine extends EPSOperator
{
   public EPSReadLine()
   {
      super("readline");
             ...
             IOException
   {
      ...
      try
      {
         ...
         EPSString substr = new EPSString(line);
      ...
      catch (NoReadAccessException e)
      {
         throw new NoReadAccessException(
            e.getMessage(), eps.getLineNum());
      }
      catch (ArrayIndexOutOfBoundsException e)
      {
         throw new ArrayIndexOutOfBoundsException(
            "readline string overflow on line "
