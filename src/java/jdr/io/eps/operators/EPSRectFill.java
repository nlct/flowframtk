// File          : EPSRectFill.java
// Purpose       : class representing rectfill operator
// Date          : 1st June 2008
...
/**
 * Object representing rectfill operator.
 * @author Nicola L C Talbot
 */
public class EPSRectFill extends EPSOperator
{
   public EPSRectFill()
   {
      super("rectfill");
...
// other forms not yet implemented
      ...
      JDRPath path = gs.rectFill(x, y, width, height);
