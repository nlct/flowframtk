// File          : EPSCvx.java
// Purpose       : class representing cvx operator
// Date          : 1st June 2008
...
/**
 * Object representing cvx operator.
 * @author Nicola L C Talbot
 */
public class EPSCvx extends EPSOperator
{
   public EPSCvx()
   {
      super("cvx");
             ...
             IOException
   {
      ...
      {
         stack.add(new EPSName(((EPSName)object)
            .toString().replaceFirst("^/", "")));
      }
      else if (object instanceof EPSArray)
      {
         EPSArray array = (EPSArray)object;
         EPSProc proc = new EPSProc();

         for (int i = 0, n=array.length(); i < n; i++)
         {
            proc.add(array.get(i));
         }
