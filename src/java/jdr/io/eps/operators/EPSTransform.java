// File          : EPSTransform.java
// Purpose       : class representing transform operator
// Date          : 1st June 2008
...
/**
 * Object representing transform operator.
 * @author Nicola L C Talbot
 */
public class EPSTransform extends EPSOperator
{
   public EPSTransform()
   {
      super("transform");
             ...
             IOException
   {
      ...
      else
      {
         ...
         Point2D ptSrc = new Point2D.Double(x, y);
         Point2D ptDst = new Point2D.Double();
         eps.getCurrentGraphicsState().transform(ptSrc, ptDst);
