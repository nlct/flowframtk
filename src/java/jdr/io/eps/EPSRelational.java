// File          : EPSRelational.java
// Purpose       : interface representing an EPS object that 
//                 can have relational operations performed on it
...
/**
 * The <code>EPSRelational</code> interface represents an 
 * Encapsulated PostScript object that 
 * can have relational operations performed on it
 * @author Nicola L C Talbot
 */
public interface EPSRelational extends EPSObject
{
   /**
    ...
    * Less than operation.
    * @param object other object
    * @return true if this is less than the other object
    * @throws InvalidEPSObjectException if the other object is
    * not compatible with this object
    */
