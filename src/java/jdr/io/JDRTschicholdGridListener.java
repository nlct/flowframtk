// File          : JDRTschicholdGridListener.java
...
public class JDRTschicholdGridListener implements JDRGridLoaderListener
{
   ...
   {
      return (version < 1.8f ? ((JDRTschicholdGrid)grid).getRectangularGrid(): grid);
   }
      ...
      throws IOException
   {
      ...
      JDRTschicholdGrid grid = (JDRTschicholdGrid)object;
      ...
      throws InvalidFormatException
   {
      ...
      return new JDRTschicholdGrid(jdr.getCanvasGraphics(),
