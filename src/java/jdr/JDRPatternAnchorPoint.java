...
public class JDRPatternAnchorPoint extends JDRPoint
{
    ...
    */
   public JDRPatternAnchorPoint(CanvasGraphics cg)
   {
      super(cg);
   }
    ...
    */ 
   public JDRPatternAnchorPoint(JDRPoint p)
   {
      super(p);
   }
    ...
    */
   public JDRPatternAnchorPoint(CanvasGraphics cg, Point p)
   {
      super(cg, p);
   }
    ...
    * @param p the location of the new point
    */
   public JDRPatternAnchorPoint(CanvasGraphics cg, Point2D p)
   {
      super(cg, p);
   }
    ...
    */
   public JDRPatternAnchorPoint(CanvasGraphics cg, double px, double py)
   {
      super(cg, px, py);
   }
   ...
   public Object clone()
   {
      return new JDRPatternAnchorPoint(this);
   }

   public int getControlFlag()
   {
      int flag = CONTROL_FLAG_PATTERN_ANCHOR;
   ...
   public static Color patternAnchorColor = new Color(51,255,51,200);
   public static Color patternAnchorSelectColor = new Color(0,100,0,200);
}
