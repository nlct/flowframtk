// File          : NonNegativeIntField.java
// Description   : Provide text fields that only allow non-negative integers
 ...
 * @author Nicola L C Talbot
 */
public class NonNegativeIntField extends NumberField
{
   /**
   ...
   {
      super(defval, new MinRangeIntFieldValidator(0));
   }
