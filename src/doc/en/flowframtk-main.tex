...
Additionally, there's a reminder of the current \gls{grid} unit and
the storage unit. If either of these are incorrect, you will need to
...
\widget{flowframe.typeblock_margins} panel or you can select one or
...
for even pages. (This corresponds to the difference between
\gls{evensidemargin} and \gls{oddsidemargin}.)
