...
\gls{textarea} had been converted to a path.
...
\dialog{controls} tab of the \dialog{config} dialog
(see \sectionref{sec:controlsettings}) or you can double-click on
the storage unit in the \gls{statusbar}.
When exporting data, most dimensions will be written in terms of the
storage unit, regardless of the unit you specify in the various
settings.
