...
Data point style markers are \manmsg{centred} on the applicable
...
Available markers are listed in \tableref{tab:arrowmarkers} (arrow
style markers), \tableref{tab:partialmarkers} (partial arrow markers),
\tableref{tab:datapointmarkers} (data point style markers),
\tableref{tab:bracketmarkers} (bracket style markers),
\tableref{tab:capmarkers} (cap style markers) and
\tableref{tab:decorativemarkers} (decorative markers).
...
\widgetdef{linestyle.winding_rule}
