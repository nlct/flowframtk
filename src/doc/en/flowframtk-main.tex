...
The \widget{flfwizard.previous} button will have its text set to the
...
The \widget{flfwizard.next} button will have its text set to the
...
(an article-like class) or \widget{flfwizard.cls.custom_cls}
(you provide the class name, for example \qtt{book} or
\qtt{scrbook} or \qtt{memoir}).
...
won't be applied until you move onto the next panel.
...
\btn{flfwizard.next} button to move to the
...
left and right margins so that the typeblock width is an integer
...
button to adjust the top and bottom margins but again the
...
Select the \widget{flfwizard.frametype.header} for a dynamic frame
...
Select the \widget{flfwizard.frametype.evenheader} for a dynamic frame
...
Select the \widget{flfwizard.frametype.footer} for a dynamic frame
...
Select the \widget{flfwizard.frametype.evenfooter} for a dynamic frame
...
Select the \widget{flfwizard.frametype.thumbtab} for a dynamic frame
...
Select the \widget{flfwizard.frametype.eventhumbtab} for a dynamic frame
...
Select the \widget{flfwizard.frametype.thumbtabindex} for a dynamic frame
with the special \qtt{thumbtabindex\meta{n}} label. The value of \meta{n}
will automatically be calculated.
...
Select the \widget{flfwizard.frametype.eventhumbtabindex} for a dynamic frame
with the special \qtt{eventhumbtabindex\meta{n}} label. The value of \meta{n}
will automatically be calculated.
...
labels, so avoid \TeX\ special characters.
...
automatically selected, but you can change the selection to another
