...
and \widget{arrow.offsettriangle2}
...
protuberance is minimised and is just enough to cover a butt line
\pathattr{cap-style}. To illustrate, \figureref{fig:offsetdeptriangle2markers}
has two lines with 20bp line width and butt \pathattr{cap-style}.
The first line has a \glsentrytext{arrow.deptriangle2} end marker and the
...
to red with 50\% alpha, which allows the end of the line to show
through the marker. The \glsentrytext{arrow.deptriangle2} is flush
...
[\glsentrytext{arrow.deptriangle2} and
\glsentrytext{arrow.offsettriangle2} Markers]
{\widget{arrow.deptriangle2} and
\widget{arrow.offsettriangle2} markers:
...
{%
  ...
  92 & \widget{arrow.offsettriangle2} 
  \end{tabular}
}
