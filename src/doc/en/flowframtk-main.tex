...
However, if you want to replace all curves with one or more straight
...
For example, in \figureref{fig:selectedcircle} a circle created with
the \tool{ellipse} has been selected.

\FloatFig{fig:selectedcircle}
{\includeimg{selectedcircle}}
{A Selected Circle}
...
the circle from \figureref{fig:selectedcircle}).
...
flatness parameter. This is the maximum allowable distance
...
\figureref{fig:selectedpolygon} is the result with the flatness set
to 4. If you change you mind you can click on the \widget{cancel}
button to discard the draft. You will be prompted for confirmation.

\FloatFig{fig:selectedpolygon}
{\includeimg{selectedpolygon}}
{Resulting Polygon}
