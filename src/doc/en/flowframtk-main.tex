...
\FloatFig
  ...
  {\includeimg[width=0.9\linewidth]{configureDialog-mathsettings}}
...
brackets such as \texttt{[weather]ifsym} (note that the package name
...
\FloatFig
  {fig:addTeXMapping}
  {\includeimg[width=0.9\textwidth]{addTeXMapping}}
...
\FloatFig
  ...
  {\includeimg[width=0.9\linewidth]{texconfig-preamble}}
...
\FloatFig
  {fig:graphics}
  {\includeimg[width=\linewidth]{configureUI-graphics}}
...
{
 {fig:hotspotsa}{\includeimg[width=0.4\textwidth]{exhotspots}}{Enabled},
 {fig:hotspotsb}{\includeimg[width=0.4\textwidth]{exnohotspots}}{Disabled}
}
{Hotspots}
