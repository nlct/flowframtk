...
\section{Paint (\Glsfmttext{index.colour}) Selector}\label{sec:paint}
...
transparent, a \dgls{paint.solid-colour} or a \dgls{gradient-paint}.
...
\section{Reducing to \Glsfmttext{index.colour.greyscale}}\label{sec:reduce}

\inlineglsdef{index.colour.greyscale}
...
\inlineglsdef{index.colour.rgb}
\inlineglsdef{index.colour.cmyk}
\inlineglsdef{index.colour.hsb}
