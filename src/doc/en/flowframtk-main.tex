...
If \widgetdef{export.textpathoutline.ignore} is selected, all
\glspl{textpath} will be exported as though the \textattr{outline} mode
was off.

\widgetdef{export.textpathoutline.topath}

If \widgetdef{export.textpathoutline.topath} is selected, all
...
\item SVG (\ext+{svg}, only in experimental mode).
\end{itemize}
