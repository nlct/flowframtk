...
line caps. The fourth line has a butt cap with a rectangle cap start
marker (shown in blue) and a round cap end marker (show in red). 
...
\subfigurefmt{c} square, \subfigurefmt{d} butt with 
