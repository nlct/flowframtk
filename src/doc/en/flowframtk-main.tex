...
The \widget{arrow.triangle2}, \widget{arrow.alttriangle2}
...
The \widget{arrow.triangle2} marker is not
...
The \widget{arrow.alttriangle2} is dependent on the
...
To illustrate the difference between the \widget{arrow.triangle2} and
\widget{arrow.alttriangle2} markers, \figureref{fig:samplemarkertriangle2}
has four lines. The top two have a \widget{arrow.triangle2} end marker
with the \widget{arrow.width} set to 5bp and the \widget{arrow.length}
set to 10bp. The bottom two have an \widget{arrow.alttriangle2} end marker
with the \widget{arrow.width} set to 5bp and the \widget{arrow.length}
...
thicker line width. The \widget{arrow.triangle2} marker (which
is independent of the line width) is now much narrower than the line
width. The  \widget{arrow.alttriangle2} marker (which does take the
...
[Triangle2 and Alt Triangle2 Markers]
{\widget{arrow.triangle2} and \widget{arrow.alttriangle2} markers:
the left two lines have 1bp line width,
the right two lines have 10bp line width,
the top two lines have a \widget{arrow.triangle2} end marker
with 5bp width and 10bp length, and
the bottom two lines have a \widget{arrow.alttriangle2} end marker
...
\fnsym{1}\inlineglsdef{arrow.triangle2}
  & \widget{arrow.length} \& \widget{arrow.width} & Independent
 & No & \includeimg{markertriangle2}\\
\fnsym{1}\inlineglsdef{arrow.alttriangle2}
...
{%
  \begin{tabular}{llll}
  90 & \widget{arrow.triangle2} & 91 & \widget{arrow.alttriangle2}\\
