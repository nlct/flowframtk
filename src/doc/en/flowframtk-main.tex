...
and \menu{selected.wizard} common menu items are also available.
...
(The \menu{tex.flowframe.set_frame} menu item will produce an error
if you haven't set the \gls{typeblock}.)
