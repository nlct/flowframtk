...
Whilst constructing a \hyperref[sec:lines]{line path}
or \hyperref[sec:curves]{curve path}, you can:

\iconstartpar{finish.png}%
Finish the \gls*{path} by pressing the \keys{\keyref{return}} key or by
\glslink{doubleclick}{double-clicking} (instead of
single-clicking) on the final vertex or by selecting
\inlineglsdef{menu.tools.finish} or by clicking on the finish button.
Note that transferring the focus to another \FlowframTk\ child
window or selecting a new tool whilst you are constructing a
\gls{path}, will complete the current path.
