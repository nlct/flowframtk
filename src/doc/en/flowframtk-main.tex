...
\glslink{rendering}{rendered} on the \gls{canvas}.
...
\glslink{rendering}{rendered} on the \gls{canvas} depending on the
font.
...
The \meta{modifier specs} are as follows:
  ...
  is followed by the line paint, fill paint and line style for when
  the underlying path is shown. (This allows the style to be
  retained if the setting was temporarily switched off when the image
  was saved.
