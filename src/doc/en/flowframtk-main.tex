...
descriptions, tags or static/dynamic frame content may contain
non-ASCII characters) so assume UTF-8 rather than ASCII.
\end{information}
...
{Additional Marker IDs (Version 2.1 Onwards)}
  ...
  available for version 1.6 onwards, and markers listed in
  \tableref{tab:jdrarrowid2.1} are available for version 2.1 onwards.
