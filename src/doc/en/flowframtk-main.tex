...
\chapter{Paint (\Glsfmttext{index.colour} and Shading)}
...
\chapter{Editing Paths}\label{sec:editpath}

\Glspl{path} consist of a sequence of segments that are defined by
\glspl{controlpt}. These \glspl{controlpt} may be adjusted in
\editpathmode.
...
distortion (see \sectionref{sec:distort}),
reversing the direction (see \sectionref{sec:reversing}),
merging paths (see \sectionref{sec:mergepaths}),
or converting into one or more other \glspl{shape}
(see \sectionref{sec:converttopolygon},
