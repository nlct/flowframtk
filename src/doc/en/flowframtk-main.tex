...
\qtt{header} frame. Using this button will not only fill in the
...
\FlowframTk\ uses this value to calculate the \qtt{evenx} attribute.
...
shown in \figureref{fig:news5a}: static type, label \qtt{title} and
...
\figureref{fig:news7}: dynamic type, label \qtt{leftheading}, no
...
shown in \figureref{fig:news9}: dynamic type, label \qtt{lefttext},
...
this \gls{bitmap}: static type, label \qtt{eggimage}, and border
...
\figureref{fig:news13}: dynamic type, label \qtt{righttext}.
...
\figureref{fig:news15}: static type and label \qtt{Lbar}.  Make sure that you have set the
...
\figureref{fig:news17}: static type, label \qtt{hline} and border shown.
...
\figureref{fig:news19}: dynamic type, label \qtt{bottomheading}, no
...
\figureref{fig:news21}: flow type, label \qtt{left} and no border. 
Similarly for the right hand lower rectangle: flow type, label
\qtt{right} and no border.
...
\figureref{fig:news23}: static type, label \qtt{sheepimage}, and
