...
The \widget{texeditor.latexcodeblock} area is, by default, on the
...
exports that use \LaTeX\ as an intermediate step.)

This area is split into tabs for the \gls{early-preamble} code,
