...
\hyperref[sec:move]{moved} to a new location.  If your
...
\LaTeX\ path, or transformation matrix), \hyperref[sec:edit]{select}
...
selection \gls{popup}. The contents of this menu vary according to
what types of \glspl*{object} have been selected, if any (see
\figureref{fig:selectpopups}).

\FloatSubFigs{fig:selectpopups}
{%
  {fig:selectpopups.none}{\includeimg{selectPopupNone}}{no objects},
  {fig:selectpopups.textpath}{\includeimg{selectPopupTextPath}}
    {only text-paths},
  {fig:selectpopups.path}{\includeimg{selectPopupPath}}{only paths},
  {fig:selectpopups.text}{\includeimg{selectPopupText}}{only \glspl{textarea}},
