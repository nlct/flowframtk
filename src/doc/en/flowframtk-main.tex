...
(black). The new \pathattr{line-paint} is now set to transparent
...
\inlineglsdef{line-style} and the \pathattr{winding-rule}. 
...
The \widget{linecolour.title} panel has a paint selector panel
...
The \widget{fillcolour.title} panel has a paint selector panel (see
...
the \pathattr{line-paint} is not set to transparent.)
\end{information}
...
The \widget{textcolour.title} panel has a paint selector panel
(see \sectionref{sec:paint}) that may be used to set the 
