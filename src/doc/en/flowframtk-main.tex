...
\FloatSubFigs{fig:grid-radial-page-margins}
{
  ...
  {fig:grid-radial-page-margins-printout}{\includeimg{grid-radial-page-margins-printout}}{},
...
\FloatSubFigs{fig:grid-radial-origin-margins}
{
  ...
  {fig:grid-radial-origin-margins-printout}{\includeimg{grid-radial-origin-margins-printout}}{},
