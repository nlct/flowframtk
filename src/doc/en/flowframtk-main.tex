...
\Glspl{compoundshape} can be separated into its constituent parts
...
path will use the default styles with the \pathattr{line-colour} the same
as the \textattr{text-colour} from the \gls*{textpath}.
...
\pathattr{fill-colour} has been retained. This is because it may be needed if the
