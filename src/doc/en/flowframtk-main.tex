...
\begin{important}
If the \hyperref[mi:gridlock]{grid lock} is on, the \selected\
\gls{object} (or \glspl{object}) will jump
...
\begin{information}
The \menu{edit.moveby} function is unaffected by the grid lock.
\end{information}
