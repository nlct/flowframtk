...
\glspl{textarea}, \sectionref{sec:modshape} to modify \glspl{shape},
...
\widgetdef{moveby.percent_width}
...
value in the \widget{moveby.percent_width} number field. (You may
...
the percentage value of the paper width and insert the value into
the \widget{coordinates.x} field.

\widgetdef{moveby.percent_height}

If you want to move the selected \gls{object} (or \glspl{object})
vertically by proportion of the paper height, enter the percentage
value in the \widget{moveby.percent_height} number field. (You may
use a negative percentage.) For example, enter \code{50} for half
the paper height.
