...
The \meta{modifier specs} are as follows:
  ...
  \end{jdrversion}
    ...
    where:
      ...
      onwards. These are both stored as a \type{char}.
...
\item If \meta{type} is not equal to 3 (i.e.\ is not the \gls{typeblock}), the following
...
(\sectionref{sec:docsource}) into the HTML and XML files required by
...
\item Use \appfmt{texjavahelpmk} (the other \TeX\ Java Help command
