...
\hyperref[sec:save]{save} the current picture,
...
\gls{bitmap} it will be equivalent to \hyperref[sec:new]{creating a
new image} and then \hyperref[sec:bitmaps]{inserting the bitmap}.
