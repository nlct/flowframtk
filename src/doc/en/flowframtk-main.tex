...
image's \gls{preamble.early} code (\sectionref{sec:preamble}), whenever the
mapping is applied.)
...
(\inlineglsdef{affine-transform.translation}), first \select\ the
...
which you can specify the angle of
\inlineglsdef{affine-transform.rotation}.
...
in which you can specify the \inlineglsdef{affine-transform.scaling} factor.
There is a choice of scaling just the $x$ dimension, just the $y$ dimension
or both dimensions.
...
\inlineglsdef{affine-transform.shearing} factors. The shearing
