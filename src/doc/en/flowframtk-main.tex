...
annotations (at the bottom left of the frame, offset by the inner
padding) and also for the file name of \glspl{bitmap} shown in draft
mode.
...
with the special \qtt{header} label. If the document is two-sided
and there is an even header frame, this frame will only be used for
odd pages. If there is no even header frame it will be used for all
pages.

The \widget{flfwizard.frametype.header} button will be disabled if
there is already an object with the special \qtt{header} label.
...
with the special \qtt{evenheader} label. If the document is two-sided
this frame will be used instead of the \qtt{header} frame. Using
this button will not only fill in the frame's label in
the next panel but will also set the page list to \qt{Even}.

The \widget{flfwizard.frametype.evenheader} button will be disabled if
there is already an object with the special \qtt{evenheader} label.
If you are editing existing \gls{flowframe} data with this label, the 
\widget{flfwizard.frametype.dynamic} button will be selected
...
with the special \qtt{footer} label. If the document is two-sided
and there is an even footer frame, this frame will only be used for
odd pages. If there is no even footer frame it will be used for all
pages.

The \widget{flfwizard.frametype.footer} button will be disabled if
there is already an object with the special \qtt{footer} label.
If you are editing existing \gls{flowframe} data with this label, the 
\widget{flfwizard.frametype.dynamic} button will be selected
...
with the special \qtt{evenfooter} label. If the document is two-sided
this frame will be used instead of the \qtt{footer} frame. Using
this button will not only fill in the frame's label in
the next panel but will also set the page list to \qt{Even}.

The \widget{flfwizard.frametype.evenfooter} button will be disabled if
there is already an object with the special \qtt{evenfooter} label.
If you are editing existing \gls{flowframe} data with this label, the 
\widget{flfwizard.frametype.dynamic} button will be selected
...
with the special \qtt{thumbtab\meta{n}} label. The value of \meta{n}
will automatically be calculated.

If the document is two-sided and there is an
\qtt{eventhumbtab\meta{n}} frame, this frame will only be used for
...
with the special \qtt{eventhumbtab\meta{n}} label. The value of \meta{n}
will automatically be calculated.
If the document is two-sided, this frame will be used instead of
\qtt{thumbtab\meta{n}} on even pages. Using
this button will not only fill in the frame's label in
the next panel but will also set the page list to \qt{Even}.
...
with the special \qtt{thumb\-tab\-index\meta{n}} label. The value of \meta{n}
will automatically be calculated.
...
\FlowframTk\ will automatically create the \qtt{thumbtabindex\meta{n}} frames
based on the corresponding \qtt{thumbtab\meta{n}} frame.
\end{information}
...
with the special \qtt{even\-thumb\-tab\-index\meta{n}} label. The value of \meta{n}
will automatically be calculated.
...
(The \menu{tex.flowframe.set_frame} menu item won't be enabled until
you have done so.)
