...
\sectionref{sec:preamble}). For example, the default preamble shown in
...
description and tag. See \sectionref{sec:text} to edit
...
\begin{information}
The \hyperref[sec:preamble]{preamble panes} have
...
\begin{information}
The \hyperref[sec:preamble]{preamble panes} have their own paste button.
\end{information}
