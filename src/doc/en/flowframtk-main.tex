...
\menu{selectedpath} popup menu that govern the \dglspl{path-attribute}
...
The \menu{selected.text} menu has the same items as the
\menu{selectedtext} popup menu that govern the
...
and a \pathattr{line-style} with a thick \pathattr{line-width} and a start marker.
...
attribute set will have a separate \pathattr{line_paint}, \pathattr{fill_paint}
and \pathattr{line-style} for the underlying shape.
