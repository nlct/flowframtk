...
\widgetdef{moveby.calc_x} button on the side. This will calculate
...
Once you have entered the desired percentage value, click on the
\widgetdef{moveby.calc_y} button on the side. This will calculate
the percentage value of the paper width and insert the value into
...
\dialog{segmentinfo} dialog box shown in
\figureref{fig:segmentinfo}.

\widgetdef{segmentinfo.title}

The \dialog{segmentinfo} dialog describes the segment type and
...
it's the end point of an open path or the end point of a
