...
\subsubsection{Clip Tag}\label{sec:cliptag}
...
Clipping is performed with \code{\gls{pgfusepath}\marg{clip}}. If you have
multiple paths with the designated clip tag, the clipping area won't
be enlarged. The \sty{pgf} manual provides further information.

If you want to scope the effects of the clipping, you will need to
insert a \env{pgfscope} environment. The simplest way to do this is
...
\cmd{renewcommand}\gls{flowframtkencapobject}\oarg{8}\marg{\comment{}
 \cmd{ifstrequal}\marg{\#2}\marg{JDRGroup}
  \marg{\cbeg{pgfscope}\#8\cend{pgfscope}}\comment{}
  \marg{\#8}\comment{}
}
\end{codebox}
